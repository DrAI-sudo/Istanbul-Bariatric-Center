...
- **Architecture**: ESG (Endoscopic Sleeve Gastroplasty) landing pages under `/esg/{country}` (e.g., UK, Germany, France, Spain, Dutch, Arabic, Italian, Russian, Romanian, Swedish, Polish, Danish, Norwegian, Hungarian, Finnish, Canadian, US).
