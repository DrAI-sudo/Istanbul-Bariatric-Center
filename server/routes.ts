...
const LEGACY_REDIRECTS: Record<string, string> = {
  "/revision-surgery": "/revision-bariatric-surgery-turkey",
  "/revision-bariatric-surgery": "/revision-bariatric-surgery-turkey",
  ...
  "/treatments/gastric-botox": "/treatments",
  "/treatments/vip-packages": "/treatments",
  "/about-us": "/about",
...
export async function registerRoutes(
  ...
  app.get("/sitemap.xml", (_req, res) => {
    ...
    const staticMeta: Record<string, { priority: string; changefreq: string; lastmod?: string }> = {
      ...
      "/dr-murat-ustun": { priority: "0.9", changefreq: "monthly", lastmod: "2026-09-17" },
      ...
      "/gastric-bypass": { priority: "0.9", changefreq: "monthly", lastmod: "2026-09-17" },
      "/gastric-sleeve-turkey": { priority: "0.9", changefreq: "monthly", lastmod: "2026-09-17" },
      "/gastric-sleeve-uk": { priority: "0.8", changefreq: "monthly", lastmod: "2026-09-17" },
      ...
      "/weight-loss-surgery-turkey": { priority: "0.8", changefreq: "monthly", lastmod: "2026-09-17" },
      ...
      "/revision-bariatric-surgery-turkey": { priority: "0.9", changefreq: "monthly", lastmod: "2026-09-17" },
      ...
      "/gastric-balloon-vs-gastric-sleeve": { priority: "0.8", changefreq: "monthly", lastmod: "2026-08-01" },
      "/weight-regain-after-gastric-sleeve": { priority: "0.8", changefreq: "monthly", lastmod: "2026-08-01" },
      "/reflux-after-gastric-sleeve": { priority: "0.8", changefreq: "monthly", lastmod: "2026-08-01" },
      "/bariatric-surgery-long-term-results": { priority: "0.8", changefreq: "monthly", lastmod: "2026-08-01" },
      "/bariatric-surgery-travel-guide": { priority: "0.8", changefreq: "monthly", lastmod: "2026-08-01" },
