...
<article><h3>POSE-2 Double Helix</h3><p>POSE-2 (Primary Obesity Surgery Endoluminal) Double Helix è una procedura di dimagrimento mini-invasiva e non chirurgica che rimodella lo stomaco con plicature a tutto spessore tramite una piattaforma di sutura endoscopica introdotta attraverso la bocca — senza incisioni. Restringe e accorcia lo stomaco fino al 70%. Perdita attesa del 15-16% del peso corporeo totale. Ideale per BMI 30-40.</p><p>Prezzi: Relax £4,950 | Lusso £5,950</p></article>
...
<article><h3>POSE-2 Double Helix</h3><p>POSE-2 (Primary Obesity Surgery Endoluminal) Double Helix — это малоинвазивная нехирургическая процедура снижения веса, при которой желудок уменьшается полнослойными складками с помощью эндоскопической сшивающей платформы, вводимой через рот, — без разрезов. Сужает и укорачивает желудок до 70%. Ожидаемая потеря 15-16% общей массы тела. Идеально для ИМТ 30-40.</p><p>Цена: Расслабляющий £4,950 | Роскошный £5,950</p></article>
...
<article><h3>POSE-2 Double Helix</h3><p>POSE-2 (جراحة السمنة الأولية عبر التجويف) Double Helix هو إجراء لإنقاص الوزن طفيف التوغل وغير جراحي يعيد تشكيل المعدة بطيات كاملة السماكة باستخدام منصة خياطة بالمنظار تُدخل عبر الفم — دون أي شقوق. يضيّق المعدة ويقصّرها بنسبة تصل إلى 70%. فقدان متوقع بنسبة 15-16% من إجمالي وزن الجسم. مثالي لمؤشر كتلة الجسم 30-40.</p><p>التسعير: باقة استرخاء £4,950 | باقة فاخرة £5,950</p></article>
...
const blogPosts: BlogPostSEO[] = [
  ...
  { slug: "revisional-bariatric-surgery-in-turkey", title: "Revisional Bariatric Surgery in Turkey!", excerpt: "Revisional bariatric surgery is performed on individuals who have previously undergone bariatric surgery.", date: "September 4, 2022", publishedAt: "2022-09-04T00:00:00+03:00", image: "/blog-gastric-sleeve.webp" },
