...
const POPUP_KEY = "ibc_promo_dismissed";
...
export default function PromoPopup() {
  ...
  return (
    ...
    >
      <div
        className="relative max-w-lg w-full rounded-2xl overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-300"
