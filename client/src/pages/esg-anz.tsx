...
export default function ESGAustraliaNZ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO title="ESG Turkey for Australia & New Zealand | Safe, Minimally Invasive Weight Loss | $8,500 USD All-Inclusive" description="Endoscopic Sleeve Gastroplasty for Australian and New Zealand patients. Procedure $7,500 USD. All-inclusive $8,500 USD at JCI-accredited hospital. Safe, minimally invasive weight loss. Free consultation." keywords="ESG Australia, ESG New Zealand, weight loss without surgery, gastroplasty Turkey, Ozempic alternative, medical tourism Istanbul, endoscopic sleeve gastroplasty ANZ" url="/esg/anz" />
