...
export default function ESGFinland() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO title="ESG Turkki suomalaisille potilaille | Laihtuminen ilman leikkausta | € 6.450 all-inclusive" description="Endoskooppinen sleeve gastroplastia suomalaisille. All-inclusive € 6.450 JCI-akkreditoidussa sairaalassa. Ilmainen konsultaatio." keywords="ESG Suomi, laihtuminen ilman leikkausta, gastroplastia Turkki, Ozempic vaihtoehto, painonpudotus hoito, mahalaukun pienennys ilman leikkausta" url="/esg/fi" />
