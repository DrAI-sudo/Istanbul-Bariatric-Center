...
export default function ESGHungary() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO title="ESG Törökország magyar betegeknek | Fogyás műtét nélkül | € 6.450 all-inclusive" description="Endoszkópos sleeve gastroplasztika műtét nélkül magyar pácienseknek. All-inclusive csomag € 6.450 JCI-akkreditált kórházban. Megtakarítás Magyarországhoz képest. Ingyenes konzultáció." keywords="ESG Magyarország, fogyás műtét nélkül, gastroplasztika Törökország, Ozempic alternatíva, testsúlycsökkentés, gyomor csökkentés műtét nélkül" url="/esg/hu" />
